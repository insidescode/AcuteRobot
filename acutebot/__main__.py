...
class Starter:
    def __init__(self, name):
        self.photo = "https://telegra.ph/file/05505d80b084a3f9695e3.jpg"
    ...
    query.message.edit_caption(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        text="🖤 Support Us 🖤", callback_data="h_about"
                    )
                ],
        ...
        query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Channel ✨", url="t.me/sluttyoreo"
                        ),
                        InlineKeyboardButton(
                            text="Group 👥", url="t.me/beluga_chat"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
